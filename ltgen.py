...
if __name__ == '__main__':
    ...
    par.add_argument('file_name', metavar='File-Name', nargs='?', default='', type=str, help='Name of the structure file generated by avogadro')
    file_name = par.parse_args().file_name
    if not file_name:
        file_name = os.popen("ls -l |grep '\<.*\.cml\>'").read().splitlines()[0].split()[-1]
